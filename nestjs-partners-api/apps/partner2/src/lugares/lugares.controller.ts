...
export class LugaresController {
  ...
  findOne(@Param('id') lugarId: string, @Param('eventoId') eventoId: string) {
    return this.spotsService.findOne({ eventId: eventoId, spotId: lugarId });
  }
  ...
  update(
    ...
    return this.spotsService.update(
      { eventId: eventoId, spotId: eventoId },
      {
  ...
  remove(@Param('id') lugarId: string, @Param('eventoId') eventoId: string) {
    return this.spotsService.remove({ eventId: eventoId, spotId: lugarId });
  }
}
